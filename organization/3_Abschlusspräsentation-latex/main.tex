...
\begin{frame}
	...
	\begin{tabular}{c|l|l|l}
		...
		\hline
		\begin{tabular}{@{}c@{}}Aufbau \\ (Linked-Cells)\end{tabular} & $\Theta(1)$ & $\Theta(p)$& $\Theta(p)$\\
		\hline
		\begin{tabular}{@{}c@{}}Aufbau \\ (Nachbar-Listen)\end{tabular}& $\Theta(p^2)$ & $\Theta(1)$ & $O(p^2\cdot \frac{27 \cdot r^3}{v})$ \\
		\hline
		Iteration&$O(p^2\cdot \frac{\frac{4}{3}\pi\cdot r^3}{v})$ &$O(p^2\cdot \frac{27 \cdot r^3}{v})$ & $O(p^2\cdot \frac{\frac{4}{3}\pi\cdot r^3}{v})$ \\
	\end{tabular}
\end{frame}
\section{Autotuneing}
