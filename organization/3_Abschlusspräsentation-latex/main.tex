...
\subsection{Nachbarschafts-Listen}
\begin{frame}
	\frametitle{Nachbarschafts-Listen}
	\begin{figure}
		\begin{center}
			\includegraphics[width=1\textheight]{List_Zoom_1.png}
		\end{center}
	\end{figure}
\end{frame}
\begin{frame}
	\frametitle{Nachbarschafts-Listen}
	\begin{itemize}
		\item Aufbau (global) $O(n^2)$
		\item Iteration $O(n\cdot ())$
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=1\textheight]{Grid_Zoom_1.png}
		\end{center}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=1\textheight]{Grid_List_Zoom_1.png}
		\end{center}
	\end{figure}
\end{frame}
\section{Autotuneing}
