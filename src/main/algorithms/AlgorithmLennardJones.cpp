...
void AlgorithmLennardJones::step_2_offset (const data_type&       p_offset_position_aix,
...
/*
void AlgorithmLennardJones::step_1_over_array (const data_type* p_position_ax,
                                               const data_type* p_position_ay,
                                               const data_type* p_position_az,
                                               data_type*       p_position_bx,
                                               data_type*       p_position_by,
    ...
    for (unsigned long particle_idx = 0; particle_idx < p_particle_count; particle_idx++) {
        step_1_local (p_position_ax[particle_idx], p_position_bx[particle_idx]);
        step_1_local (p_position_ay[particle_idx], p_position_by[particle_idx]);
        step_1_local (p_position_az[particle_idx], p_position_bz[particle_idx]);
    }
}

void AlgorithmLennardJones::step_2_single (const data_type& p_position_aix,
                                           const data_type& p_position_aiy,
                                           const data_type& p_position_aiz,
                                           data_type&       p_position_bix,
                                           data_type&       p_position_biy,
