...
BOOST_AUTO_TEST_CASE (test_datastructureGRID) {
    ...
    s_options options_compare;
    memset (&options_compare, 0, sizeof (s_options));
    options_compare.m_data_structure = e_datastructure_type::GRID;
...
BOOST_AUTO_TEST_CASE (test_datastructureLIST) {
    ...
    s_options options_compare;
    memset (&options_compare, 0, sizeof (s_options));
    options_compare.m_data_structure = e_datastructure_type::LIST;
...
BOOST_AUTO_TEST_CASE (test_datastructureLISTEDGIRD) {
    ...
    s_options options_compare;
    memset (&options_compare, 0, sizeof (s_options));
    options_compare.m_data_structure = e_datastructure_type::LISTEDGIRD;
...
BOOST_AUTO_TEST_CASE (test_load_config) {
    ...
    memset (&options_test, 0, sizeof (s_options));
    std::vector<const char*> args = { "./particle_simulation.x",
                                      "--load_config=../Resources/config1.xml" };
    int res = handler.handle_options ((int) args.size (), const_cast<char**> (args.data ()), options_test);
    BOOST_CHECK_EQUAL (res, 0);
    BOOST_CHECK_EQUAL (options_test.m_algorithm_type, e_algorithm_type::LENNARD_JONES);
    BOOST_CHECK_EQUAL (options_test.m_autotuneing, false);
    BOOST_CHECK_EQUAL (options_test.m_output_type, e_output_type::FILE_CSV);
    BOOST_CHECK_EQUAL (options_test.m_in_file_name, "inabcde.xml");
    BOOST_CHECK_EQUAL (options_test.m_out_file_name, "outabcde.xml");
    BOOST_CHECK_EQUAL (options_test.m_timestep, 1);
    BOOST_CHECK_EQUAL (options_test.m_verbose, false);
    BOOST_CHECK_EQUAL (options_test.m_write_fequency, 1);
    BOOST_CHECK_EQUAL (options_test.m_cut_off_radius, 0.01);
    BOOST_CHECK_EQUAL (options_test.m_data_structure, e_datastructure_type::GRID);
    BOOST_CHECK_EQUAL (options_test.m_input_type, e_input_type::GENERATOR_GRID_DISTRIBUTION);
    BOOST_CHECK_EQUAL (options_test.m_seed, 123456789);
    BOOST_CHECK_EQUAL (options_test.m_particle_count, 2);
    BOOST_CHECK_EQUAL (options_test.m_max_iterations, 6);
    BOOST_CHECK_EQUAL (options_test.m_bounds, Vec3f (5.0f, 5.0f, 5.0f));
    BOOST_CHECK_EQUAL (options_test.m_max_iterations_between_datastructure_rebuild, 20);
    BOOST_CHECK_EQUAL (options_test.m_write_modes[e_csv_column_type::ID], true);
    BOOST_CHECK_EQUAL (options_test.m_write_modes[e_csv_column_type::POSITION], true);
    BOOST_CHECK_EQUAL (options_test.m_write_modes[e_csv_column_type::VELOCITY], true);
    BOOST_CHECK_EQUAL (options_test.m_write_modes[e_csv_column_type::ACCELERATION], true);
    BOOST_CHECK_EQUAL (options_test.m_write_modes[e_csv_column_type::PARTICLE_TYPE], false);
}
BOOST_AUTO_TEST_CASE (test_save_config) {
    OptionHandler handler;
    s_options     options_test;
    memset (&options_test, 0, sizeof (s_options));
    options_test.m_algorithm_type = e_algorithm_type::LENNARD_JONES;
    options_test.m_autotuneing    = false;
    options_test.m_output_type    = e_output_type::FILE_CSV;
    options_test.m_in_file_name   = "inabcde.xml";
    options_test.m_out_file_name  = "outabcde.xml";
    options_test.m_timestep       = 1;
    options_test.m_verbose        = false;
    options_test.m_write_fequency = 1;
    options_test.m_cut_off_radius = 0.01;
    options_test.m_data_structure = e_datastructure_type::GRID;
    options_test.m_input_type     = e_input_type::GENERATOR_GRID_DISTRIBUTION;
    options_test.m_seed           = 123456789;
    options_test.m_particle_count = 2;
    options_test.m_max_iterations = 6;
    options_test.m_bounds.x       = 5.0f;
    options_test.m_bounds.y       = 5.0f;
    options_test.m_bounds.z       = 5.0f;
    options_test.m_max_iterations_between_datastructure_rebuild  = 20;
    options_test.m_write_modes[e_csv_column_type::ID]            = true;
    options_test.m_write_modes[e_csv_column_type::POSITION]      = true;
    options_test.m_write_modes[e_csv_column_type::VELOCITY]      = true;
    options_test.m_write_modes[e_csv_column_type::ACCELERATION]  = true;
    options_test.m_write_modes[e_csv_column_type::PARTICLE_TYPE] = false;
    std::vector<const char*> args                                = { "./particle_simulation.x",
                                      "--save_config=../Temporary/test_save_config.xml" };
    int res = handler.handle_options ((int) args.size (), const_cast<char**> (args.data ()), options_test);
    BOOST_CHECK_EQUAL (res, 0);
    std::ifstream               ifs1 ("../Temporary/test_save_config.xml");
    std::ifstream               ifs2 ("../Resources/config1.xml");
